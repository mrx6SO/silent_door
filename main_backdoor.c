...
#define remote_addr "192.168.1.14" /* your dark server here */
...

  {
   ...
   /* the daemon thing... */
    ...
    /* setting up the connection */
     ...
     s.sin_addr.s_addr = inet_addr(remote_addr); /* conexão a remote_addr, definido nas declarações */
     s.sin_port = htons(remote_port); /* conexõa a remote_port, definida nas declarações */
